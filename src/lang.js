...
const langData = {
    ...
    travelinfo: {
        ...
        approximately five countries in Europe🚩. You can view my wonderful travel photos📸 and working process⏳ in Europe by clicking the "Album"📂 button.`,
        ...
        примерно пять стран Европы🚩. Вы можете просмотреть мои замечательные фотографии📸 путешествий и рабочий процесс⏳ в Европе, нажав кнопку "Альбом"📂.`
    },
    contacts: {
        en: "CONTACT ME*",
        ru: "Мои контакты*"
